...
awk '{ split($NF,arr,"_"); print $0"\t"arr[4]"\t"$9"_"$10"_"$11"_"$12"_"$14"_"$15"_"$16"_"$17"_"$18"_"$19 }' targetGeneCorrelations.greater_than_0.7_and_p_less_than_0point01.bed | bedtools groupby -i stdin -c 22 -o collapse > targetGeneCorrelations.greater_than_0.7_and_p_less_than_0point01.collapsed.bed
 # head targetGeneCorrelations.greater_than_0.7_and_p_less_than_0point01.collapsed.bed
#chr1	87640	87790	0.78	chr1_52473_52473_ENST00000606857.1_+_ENSG00000268020.2_KNOWN_OR4G4P_OR4G4P-001_2
#chr1	125340	125490	0.73,0.73	chr1_129173_129173_ENST00000471248.1_-_ENSG00000238009.2_NOVEL_RP11-34P13.7_RP11-34P13.7-002_2,chr1_129217_129217_ENST00000477740.1_-_ENSG00000238009.2_NOVEL_RP11-34P13.7_RP11-34P13.7-003_2
